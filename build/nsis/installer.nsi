...
!define MULTIUSER_INSTALLMODE_INSTDIR "Filalyze"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\Filalyze.lnk" "$INSTDIR\Python\python.exe" \
      '"$INSTDIR\Filalyze.launch.py"' "$INSTDIR\glossyorb.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\Filalyze.launch.py"
    Delete "$INSTDIR\glossyorb.ico"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\Filalyze.lnk"
  RMDir $INSTDIR
